...
param_excl_3m_p="/gfsvol01/cms/users/pauletto/work/tensorflow/parametrize_all/Plots/StandardScaler/DNN_layers_512_512__batchsize_32768__classes_4_TTbar_ST_WJets+DY_RSGluonToTT__epochs_50__eqweight_False__preprocess_StandardScalerexclM_3000_3500_4000/graphs.root"
nonparam_excl_3m_p="/gfsvol01/cms/users/pauletto/work/tensorflow/nonparametrized/Plots/StandardScaler/DNN_layers_512_512__batchsize_32768__classes_4_TTbar_ST_WJets+DY_RSGluonToTT__epochs_50__eqweight_False__preprocess_StandardScalerexclM_3000_3500_4000/graphs.root"
...
nonparam_excl_2500_3000=readgraph(nonparam_excl_3m_p)
param_excl_2500_3000=readgraph(param_excl_3m_p)
...
nonparam_excl_2500_3000.SetTitle("Non parametrized, trained excluding 3000,3500,4000 GeV sigs")
param_excl_2500_3000.SetTitle("Parametrized, trained excluding 3000,3500,4000 GeV sigs")
...
mg = ROOT.TMultiGraph()
mg.SetTitle("F1 scores, comparing the DNNs trained on all masses with DNNs trained excluding the 2500,3000 GeV samples;Signal mass [GeV];F1 scores")
...
canvas.BuildLegend()
canvas.SaveAs("ScorePlots/gluon_3m_F1_param_nonparam.pdf")
"""
