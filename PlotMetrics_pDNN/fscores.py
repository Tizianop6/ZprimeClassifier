...
param_excl_4000_p="/gfsvol01/cms/users/pauletto/work/tensorflow/parametrize_all/Plots/StandardScaler/DNN_layers_512_512__batchsize_32768__classes_4_TTbar_ST_WJets+DY_RSGluonToTT__regmethod_dropout__regrate_050000__batchnorm_False__epochs_50__learningrate_000050__runonfraction_100__eqweight_False__preprocess_StandardScaler__priorSigma_100exclM_4000/graphs.root"
...
nonparam_excl_4000=readgraph(param_excl_500_1000_p)
param_excl_4000=readgraph(nonparam_excl_500_1000_p)
...
nonparam_excl_4000.SetTitle("Non parametrized, excluding 4000 GeV sigs")
param_excl_4000.SetTitle("Parametrized, excluding 4000 GeV sigs")
...
param_excl_4000.SetLineColor(ROOT.kRed)
param_excl_4000.SetMarkerColor(ROOT.kRed)
...
mg = ROOT.TMultiGraph()
mg.SetTitle("Comparison of F1 scores for the Kaluza-Klein gluon class;Signal mass [GeV];F1 scores")
...
canvas.BuildLegend()
canvas.SaveAs("ScorePlots/F1_param_nonparam.pdf")
"""
