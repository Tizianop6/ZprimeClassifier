...
nonparam_all_p="/gfsvol01/cms/users/pauletto/work/tensorflow/nonparametrized/Plots/StandardScaler/DNN_layers_512_512__batchsize_32768__classes_4_TTbar_ST_WJets+DY_ZprimeDMToTTbarResoIncl__epochs_50__eqweight_False__preprocess_StandardScalerexclM_/graphs.root"
param_all_p="/gfsvol01/cms/users/pauletto/work/tensorflow/parametrize_all/Plots/StandardScaler/DNN_layers_512_512__batchsize_32768__classes_4_TTbar_ST_WJets+DY_ZprimeDMToTTbarResoIncl__epochs_50__eqweight_False__preprocess_StandardScalerexclM_/graphs.root"
...
param_excl_2500_3000_p="/gfsvol01/cms/users/pauletto/work/tensorflow/parametrize_all/Plots/StandardScaler/DNN_layers_512_512__batchsize_32768__classes_4_TTbar_ST_WJets+DY_ZprimeDMToTTbarResoIncl__epochs_50__eqweight_False__preprocess_StandardScalerexclM_2500_3000/graphs.root"
nonparam_excl_2500_3000_p="/gfsvol01/cms/users/pauletto/work/tensorflow/nonparametrized/Plots/StandardScaler/DNN_layers_512_512__batchsize_32768__classes_4_TTbar_ST_WJets+DY_ZprimeDMToTTbarResoIncl__epochs_50__eqweight_False__preprocess_StandardScalerexclM_2500_3000/graphs.root"
...
nonparam_excl_2500_3000=readgraph(nonparam_excl_2500_3000_p)
param_excl_2500_3000=readgraph(param_excl_2500_3000_p)
...
nonparam_excl_2500_3000.SetTitle("Non parametrized, trained excluding 2500,3000 GeV sigs")
param_excl_2500_3000.SetTitle("Parametrized, trained excluding 2500, 3000 GeV sigs")
...
nonparam_excl_2500_3000.SetLineStyle(ROOT.kDotted)


param_excl_2500_3000.SetLineColorAlpha(ROOT.kRed,0.8)
param_excl_2500_3000.SetLineStyle(ROOT.kDotted)
param_excl_2500_3000.SetMarkerColorAlpha(ROOT.kRed,0.8)
...
mg = ROOT.TMultiGraph()
mg.SetTitle("F1 scores, DNNs trained on all masses;Signal mass [GeV];F1 scores")
...
#mg.Add(nonparam_excl_2500_3000)
#mg.Add(param_excl_2500_3000)

# Crea un canvas per disegnare il TMultiGraph
mg.Draw("APL")  # "A" per disegnare gli assi
canvas.BuildLegend()
canvas.SaveAs("ScorePlots/zprimeF1_param_nonparam.pdf")
"""
