...
def GetInputsDifferentMassesParametrized(parameters):
    ...
    maxfiles_per_sample = {'TTbar': -2, 'WJets-high': 3, 'WJets-low': 3, 'WJets': -1, 'ST': -2, 'DY':-2, 'Zprime': 3, 'QCD': 3, 'RSGluonToTT': -1,'RSGluonToTT_M-6000':-1,'RSGluonToTT_M-3000':-1, 'RSGluonToTT_M-500':-1, 'ZprimeDMToTTbarResoIncl':-1}
...
def GetInputsDifferentMasses(parameters):
    ...
    maxfiles_per_sample = {'TTbar': -1, 'WJets-high': 3, 'WJets-low': 3, 'WJets': -1, 'ST': -1, 'DY':-1, 'Zprime': 3, 'QCD': 3, 'RSGluonToTT': -1,'RSGluonToTT_M-6000':-1,'RSGluonToTT_M-3000':-1, 'RSGluonToTT_M-500':-1}
    # Find initial file for each class
#    inputfiles = os.listdir('input/MLInput')
#    inputfiles = os.listdir(inputdir+systvar+inputsubdir)
    inputdir=bkginputdir
