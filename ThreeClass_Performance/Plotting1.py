...
def PlotROCsMassAlternative(parameters, inputfolder, outputfolder, filepostfix, plotfolder, use_best_model=False, usesignals=[0],mass=0):
    ...
    PRscore=precision_recall_fscore_support(max_value_index_labels,max_value_index_pred,beta=1.0,sample_weight=new_sample_weights_val)
    print("m=",mass ," precision-recall score", PRscore)
